...
Librum makes several major changes to character progression, described by the following comparison table:
 ...
 | You can open your map whenever you want. | You must have a Map of [Location] equipped in your shield hand to open the map. Maps eventually break the more you use them, and if you take damage with your map equipped.
